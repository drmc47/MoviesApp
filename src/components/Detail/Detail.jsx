...
function Detail({location: {search}}) {
    ...
    useEffect(() => {
    axios.get(`https://www.omdbapi.com/?i=${id}&apikey=a99b2602`)
    .then(response => {
    ...
    return (
        ...
        <div className='container detailDiv'>
            ...
            <div className='d-flex'>
                ...
                <div>
                    <p><b> Fecha de estreno</b>  {detail.Year}</p>
                    <p><b>IMBD Rating:</b>  {detail.imdbRating}</p>
                    <p><b>Genero:</b> {detail.Genre}</p>
                </div>
            </div>
